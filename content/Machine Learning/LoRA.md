...
LoRA appears at the age when adaption to varying kinds of down-stream tasks is very popular. And the adaption is usually done with _fine-tuning_, which updates all parameters of the pre-trained model. LoRA can be seen as a generalization of full fine-tuning, which fine-tune part of the parameters and fine-tune part of the ranks.
